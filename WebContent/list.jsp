...
<form action="Servlet"  method="POST">
	<input type="hidden" name="case" value="post"/>
	<input type="text" name="data" value="添加数据"><br>
	<input type="submit" name="确定">
</form>
<form action="Servlet"  method="POST">
	<input type="hidden" name="case" value="edit"/>
	<input type="text" name="data" value="修改数据"><br>
	<input type="text" name="index" value="位置"><br>
	<input type="submit" name="确定">
</form>
</box>
</body>